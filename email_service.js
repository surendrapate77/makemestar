...
// Configure nodemailer transporter for sending emails using the working 'gmail' service shorthand
const transporter = nodemailer.createTransport({
  service: 'gmail', // Use Gmail service for optimized SMTP settings
  auth: {
